...
plot.AgreeClust(res.pedag, choice = "seg", col.clust = c("#FF8379", "#009193"), new.dev = FALSE)
```
...
plot.AgreeClust(res.pedag, choice = "mul", col.clust = c("#42B983", "#F36170"), new.dev = FALSE)
```
...
```{r eval=FALSE}
plot.AgreeClust(res.pedag, choice = "mul", axis = c(3, 4), new.dev = FALSE)
```

```{r echo=FALSE, fig.width=8, dpi=400, fig.height=5, message=FALSE, results=FALSE}
plot.AgreeClust(res.pedag, choice = "mul", axis = c(3, 4), col.clust = c("#42B983", "#F36170"), new.dev = FALSE)
```
...
```{r echo=FALSE, fig.width=8, dpi=400, fig.height=8, message=FALSE, results=FALSE}
plot.AgreeClust(res.pedag, choice = "seg", col.clust = c("#42B983", "#F36170"), new.dev = FALSE)
```
