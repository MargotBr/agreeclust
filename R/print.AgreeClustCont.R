print.AgreeClustCont <- function (res){

  if (!inherits(res, "AgreeClustCont")){
    stop("Non convenient data - res should be an AgreeClustCont object")
  }

  cat("** Results for the agreement-based clustering (AgreeClustCont) **\n")
  cat("\n")
